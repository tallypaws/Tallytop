            ...
            <ModalContent>
                <div style={{ padding: "1em 0" }}>
                    ...
                    <div className={cl("button-grid")}>
                        <Button onClick={() => TallytopNative.debug.launchGpu()}>Open chrome://gpu</Button>
                        <Button onClick={() => TallytopNative.debug.launchWebrtcInternals()}>
...
const VencordLocationPicker: SettingsComponent = ({ settings }) => {
    ...
    const usingCustomVencordDir = TallytopNative.fileManager.isUsingCustomVencordDir();
    ...
    return (
        <>
            <Paragraph>
                ...
                {usingCustomVencordDir ? (
                    <TextButton
                        ...
                        onClick={e => {
                            e.preventDefault();
                            TallytopNative.fileManager.showCustomVencordDir();
                        }}
                    >
                        a custom location
                    </TextButton>
            ...
            <div className={cl("button-grid")}>
                <Button
                    onClick={async () => {
                        const choice = await TallytopNative.fileManager.selectVencordDir();
                        switch (choice) {
                            case "cancelled":
                                break;
                            case "ok":
                ...
                <Button
                    ...
                    onClick={async () => {
                        await TallytopNative.fileManager.selectVencordDir(null);
                        forceUpdate();
                    }}
                >
                    Reset
